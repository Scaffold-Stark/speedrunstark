...
const Dex: NextPage = () => {
    ...
    const {sendAsync: balloonsApprove} = useScaffoldWriteContract({
        ...
        args: [
            approveSpender,
            NUMBER_REGEX.test(approveAmount) ? multiplyTo1e18(approveAmount) : BigInt(approveAmount),
        ],
    });
    ...
    const {formatted: formatedContractSTRKBalance} = useScaffoldStrkBalance({address: DexInfo?.address || ""});
          ...
          💦💦: {parseFloat(formatEther((userLiquidity)?.toString() || 0n))}
            ...
            <div className="items-start pt-10 grid grid-cols-1 md:grid-cols-2 content-start">
                <div className="px-5 py-5">
                    <div
                        className="bg-base-100 shadow-lg shadow-secondary border-8 border-secondary rounded-xl p-8 m-8">
                ...
                {" "}
                                ...
                                {isLoading ? (
                                    ...
                                    <span
                                        className="pl-8 text-xl">🎈 {parseFloat(formatEther((DexBalloonBalance)?.toString() || 0n))}</span>
                                )}
              </span>
                        </div>
                  ...
                  tokenToSTRK{" "}
                    ...
                    />
                        ...
                        <div className="px-4 py-3">
                            <div className="flex mb-4 justify-center items-center">
                <span className="w-1/2">
                  Deposit <IntegerInput value={depositAmount}
                            ...
                            <div className="flex justify-center items-center">
                <span className="w-1/2">
                  Withdraw <IntegerInput value={withdrawAmount}
                    ...
                    <div
                        className="space-y-4 bg-base-100 shadow-lg shadow-secondary border-8 border-secondary rounded-xl py-5 p-8 m-8">
                ...
                <span className="w-1/2">
                  ...
                  />
                                ...
                                <button
                                    ...
                                    onClick={wrapInTryCatch(() => balloonsApprove(), "balloonsApprove")}
                                >
                                    Send
                                </button>
                                <span className="w-1/2">
                    ...
                    BAL Balance: {parseFloat(formatEther(balanceOfWrite?.toString() || '0'))}
                  </span>
                                )}
                            </div>
                        </div>
                ...
                <div className="mx-auto p-8 m-8 md:sticky md:top-0">
                    <Curve
                        addingStrk={strkToTokenAmount !== "" ? parseFloat(strkToTokenAmount.toString()) : 0}
                        addingToken={tokenToSTRKAmount !== "" ? parseFloat(tokenToSTRKAmount.toString()) : 0}
                        strkReserve={parseFloat(formatedContractSTRKBalance)}
                        tokenReserve={parseFloat(formatEther(contractBalance?.toString() || '0'))}
                        width={500}
                        height={500}
