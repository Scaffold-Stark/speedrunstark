...
const RateInput: React.FC<RateInputProps> = ({
  ...
  return (
    <div className="flex justify-end items-center w-full h-10">
      ...
      <span className="w-1/5 label-text text-base whitespace-nowrap">
        {label}
      </span>
      ...
      <div className="ml-2 w-3/5">
        {isEditing ? (
          ...
          <span className="flex px-2 justify-center font-medium">
  ...
  return (
    <div className="card bg-base-100 w-full shadow-xl indicator">
      <TooltipInfo
        top={3}
        right={3}
        infoText="Set the borrow rate and savings rate for the engine in %"
      />
