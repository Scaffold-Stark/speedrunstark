...
const deployedContracts = {
  devnet: {
    YourToken: {
      address:
        "0x3d833c803c818bd5f08ace4b0e3ef3e86c19ed246dab32c03b12c027281e5b0",
      abi: [
        {
          type: "impl",
          name: "IYourTokenImpl",
        ...
        {
          type: "event",
          name: "contracts::your_token::YourToken::Event",
          kind: "enum",
          variants: [
            {
              name: "ERC20Event",
      ...
      classHash:
        "0xd915bd4a4b35b3254be7a166023742bf270a149f10a219341caaa49db81a81",
    },
  },
} as const;
